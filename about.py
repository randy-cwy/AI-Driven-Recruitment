...
def about_page():
    ...
    tab1, tab2, tab3, tab4 = st.tabs(
        ["🎯 Objectives/Use Case", "📚 Data Sources", "✨ Key Features", "🚀 Future Improvements"]
    )

    # Tab 1: Objectives/Use Case
    with tab1:
        ...
        <ul class="about-list">
            ...
            <li><b>Efficiently Rank Candidates:</b> Streamline the process to rank candidates based on relevant skills and experience.</li>
    ...
    with tab2:
        ...
        <ul class="about-list">
            ...
            <li><b>SkillsFuture Framework:</b> The publicly available SkillsFuture Framework that allows for matching job responsibilities to relevant skills.</li>
    ...
    # Optional: Add an image or logo if needed
